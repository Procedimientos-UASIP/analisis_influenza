...
# ESPECIFICAR NUMERO MÁXIMO DE PROCESADORES POR PROCESO
# SINGLE_LOCAL_PROC=28

# DIRECTORIO PARA ARCHIVOS TEMPORALES. NO USAR TMP NATIVO PORQUE NO HAY SUFICIENTE ASIGNADO
